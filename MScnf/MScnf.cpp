...
string modul_name = "cnf";
int modul_num = 3;
string version = "Cnf v.2.0.1, build 10.11.2016 17:15";
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
...
************************************************************************/
		...
		init_Params.reset(new IPar(argv, modul_name)); //Create storage for init parametrs and parse init file
		LogsInit(modul_name);
