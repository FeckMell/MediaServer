...
MGCP::MGCP(bool parse_) :request((char*)COM::GS(COM::OUTER::mgcp_)->buffer), sender(COM::GS(COM::OUTER::mgcp_)->endPoint)
{
...
void MGCP::SendClient(string str_)
{
	...
	COM::GS(COM::OUTER::mgcp_)->s.send_to(boost::asio::buffer(str_), sender);
}
//*///------------------------------------------------------------------------------------------
//*///------------------------------------------------------------------------------------------
void MGCP::ReplyNTFY()
